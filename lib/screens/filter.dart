...
class Filter extends StatefulWidget {
  Filter({Key? key, this.selected_filter = "product", this.selected_cat_id})
      : super(key: key);

  final String selected_filter;
  dynamic selected_cat_id;
...
class _FilterState extends State<Filter> {
  ...
  fetchProductData() async {
    ...
    if (widget.selected_cat_id != null) {
      print("if--");
      print("SC-->$_selectedCategories");
      print("if_searchKey-->$_searchKey");
      var productResponse = await ProductRepository().getFilteredProducts(
          ...
          categories: widget.selected_cat_id.toString(),
      ...
      print("else--");
      print("ontap__selectedBrands-->$_selectedBrands");
      print("SC-->$_selectedCategories");
      var productResponse = await ProductRepository().getFilteredProducts(
          page: _productPage,
          name: _searchKey,
  ...
  fetchShopData() async {
    ...
    print("shop list:${_shopList.length}");
                  ...
                  return Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text("Total Shop:" + _totalShopData.toString()),
                        ],
                      ),
                      ListTile(
                        dense: true,
                    ...
                    FlatButton(
                      ...
                      onPressed: () {
                        ...
                        if (apply) {
                          ...
                          print(
                              "ontap_selectedCategories-->$_selectedCategories");
                          print("ontap_searchKey-->$_searchKey");
                          widget.selected_cat_id = null;
                          print("ontap__selectedBrands-->$_selectedBrands");
                          print("ontap_searchKey-->$_searchKey");
                          _applyProductFilter();
                        }
            ...
            children: [
              ...
              GridView.builder(
                ...
                itemBuilder: (context, index) {
                  // 3
                  return _productList[index].thumbnail_image != null
                      ? ProductCard(
                          id: _productList[index].id,
                          shop_name: _productList[index].shop_name,
