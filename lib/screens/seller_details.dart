...
class _SellerDetailsState extends State<SellerDetails> {
  ...
  fetchFilteredBrands() async {
    var filteredBrandResponse =
        await BrandRepository().getFilterSellerBrands(id: widget.id);
  ...
  fetchProductDetails() async {
    ...
    if ((shopDetailsResponse.shops?.length ?? 0) > 0) {
  ...
  fetchNewArrivalProducts() async {
    var newArrivalProductResponse =
        await ShopRepository().getNewFromThisSellerProducts(id: widget.id ?? 0);
  ...
  fetchTopProducts() async {
    var topProductResponse =
        await ShopRepository().getTopFromThisSellerProducts(id: widget.id ?? 0);
  ...
  fetchFeaturedProducts() async {
    var featuredProductResponse = await ShopRepository()
        .getfeaturedFromThisSellerProducts(id: widget.id ?? 0);
  ...
  buildfeaturedProductList() {
    if (_featuredProductInit == false && _featuredProducts.length == 0) {
      ...
      return _searchFeatured.isNotEmpty
          ? GridView.builder(
              // 2
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    ...
                    child: ListProductCard(
                        ...
                        image: _searchTop[index].thumbnail_image != null
                            ? _searchTop[index]
                                .thumbnail_image
                                .replaceAll(",", "")
                            : null,
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    ...
                    child: ListProductCard(
                        ...
                        image: _topProducts[index].thumbnail_image != null
                            ? _topProducts[index]
                                .thumbnail_image
                                .replaceAll(",", "")
                            : null,
  ...
  buildNewArrivalList() {
    if (_newArrivalProductInit == false && _newArrivalProducts.length == 0) {
      ...
      return _searchNewArrival.isNotEmpty
          ? SingleChildScrollView(
              child: SizedBox(
                height: 175,
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: MiniProductCard(
                        ...
                        image: _searchNewArrival[index].thumbnail_image != null
                            ? _searchNewArrival[index]
                                .thumbnail_image
                                .replaceAll(",", "")
                            : null,
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: MiniProductCard(
                        ...
                        image:
                            _newArrivalProducts[index].thumbnail_image != null
                                ? _newArrivalProducts[index]
                                    .thumbnail_image
                                    .replaceAll(",", "")
                                : null,
                                    ...
                                    TextButton(
                                        onPressed: () async {
                                          Navigator.of(context,
                                              ...
                                              .pop();
                                          final url =
                                              'https://www.google.com/maps/search/${Uri.encodeFull(_shopDetails.address)}';
                          ...
                          children: [
                            InkWell(
                                onTap: () async {
                                  ...
                                  print(likeShop);
                                  if (likeShop == true) {
                                    var postLike = await ShopRepository()
                                        .postLikes(
                                            id: widget.id, userId: user_id.$);
