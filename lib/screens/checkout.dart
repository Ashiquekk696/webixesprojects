...
class _CheckoutState extends State<Checkout> {
  ...
  fetchSummary() async {
    ...
    print("cartSummaryResponse-->$cartSummaryResponse");
    if (cartSummaryResponse != null) {
      _subTotalString = cartSummaryResponse.sub_total ?? "";
      _taxString = cartSummaryResponse.tax ?? "";
      _serviceTax = cartSummaryResponse.serviceTax ?? "";
      ...
      _grandTotalValue = cartSummaryResponse.grand_total_value ?? 0;
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              Expanded(
                  child: Text(
                "Enter product details here\n(like medical prescription or bill)",
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(
                  "Fast Shipping1 days delivary for \$1.0",
                  style: TextStyle(fontSize: 14),
                )
              ],
            ),
            Row(
              children: [
                ...
                Text(
                  "Reguler3-7 days delivary for \$0.4",
                  style: TextStyle(fontSize: 14),
                )
              ],
            ),
            Row(
              children: [
                ...
                Text(
                  "Courier5-8 days delivary for \$0.3",
                  style: TextStyle(fontSize: 14),
                )
              ],
            ),
