...
class _AddressState extends State<Address> {
  ...
  fetchShippingAddressList() async {
    ...
    if (_shippingAddressList.length > 0) {
      ...
      _shippingAddressList.forEach((address) {
        ...
        AppConfig.address = address.address +
            " " +
            address.postal_code +
            " " +
  ...
  //     print("value-->$value");
  //     return orderCreateResponseFromJson(value);
  //   });
  // }
  ...
  onAddressSwitch(index) async {
    ...
    if (addressMakeDefaultResponse.result == false) {
      ToastComponent.showDialog(
          addressMakeDefaultResponse.message ?? "", context,
  ...
  onSelectCountryDuringUpdate(index, country, setModalState) {
    ...
    // _selected_state_list_for_update[index] = 0;
    // _selected_city_list_for_update[index] = 0;
    setState(() {});
