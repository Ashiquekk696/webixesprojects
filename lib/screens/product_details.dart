...
import 'package:webixes/screens/seller_policy_page.dart';
...
import 'package:webixes/helpers/color_helper.dart';
...
import 'dart:async';
import 'package:webixes/screens/video_description_screen.dart';
                        ...
                        /* Navigator.push(context,
                          ...
                          return CommonWebviewScreen(
                           // url: "${AppConfig.RAW_BASE_URL}/mobile-page/returnpolicy",
                            url:"${AppConfig.RAW_BASE_URL}/api/v2/policies/shop?type=return_policy&shop_id=${widget.id}",
