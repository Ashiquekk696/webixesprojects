...
import 'dart:convert';
import 'package:webixes/data_model/cart_response.dart';
import 'package:webixes/data_model/cart_delete_response.dart';
import 'package:webixes/data_model/cart_process_response.dart';
import 'package:webixes/data_model/cart_add_response.dart';
import 'package:webixes/data_model/cart_summary_response.dart';
...
class CartRepository {
  ...
  Future<CartSummaryResponse> getCartSummaryResponse() async {
    ...
    print("cart-summary-->${AppConfig.BASE_URL}/cart-summary/${user_id.$}");
    print("cart-summary-->${response.body}");
